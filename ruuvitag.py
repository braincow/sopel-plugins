...
def configure(config):
    ...
    config.ruuvitag.configure_setting('sa_json', 'Where is the GCP service account key file located at (aka filename)?')
    config.ruuvitag.configure_setting('endpoint', 'What is the GCP cloud function endpoint URL to call?')
